...
const SingleProductDetails = ({ productBox, setBookedMobile }) => {
    ...
    const [isSeller] = SellerHooks(user?)
        ...
        <div >
            <div className="card w-96 bg-base-100 shadow-xl ">
                <figure className="p-10">
                    <img src={picture} alt="Shoes" className="rounded-xl border border-accent ring ring-accent ring-offset-base-100 ring-offset-2 p-5 " />
                </figure>
