            ...
            <div className='m-16 grid gap-5 justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 '>
                {
                    phones.map((phone, i) => <div key={i}>
                        ...
                        <div class="flex max-w-sm overflow-hidden border-xl rounded-lg shadow-lg bg-gradient-to-r from-blue-900 via-blue-500
                         to-blue-900 ">
                            <div class="w-1/3 bg-cover">

                                <div className="avatar mt-3 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                            ...
                            <div class="w-2/3 p-4 md:p-4">
                                <h1 class="text-2xl font-bold text-gray-800 text-white">{phone.category_name}</h1>
