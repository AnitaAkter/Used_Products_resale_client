...
const Footer = () => {
    return (
        <footer className="p-6 bg-gradient-to-r from-blue-600 via-blue-800 to-blue-900 dark:text-black-700 font-semibold text-white">
            ...
            <div className="flex items-center justify-center px-6 pt-12 text-sm">
                <span className="dark:text-gray-600">© Copyright 2022. All Rights Reserved.</span>
            </div>
        </footer>
    );
};
