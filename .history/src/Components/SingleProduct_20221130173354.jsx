...
const SingleProduct = () => {
    ...
    return (
        <div className="grid grid-cols-1 m-5 lg:grid-cols-3 md:grid-cols-1 gap-5">
            {
                categoriesProduct.map((productBox,i) => <SingleProductDetails key={productBox._id} bookingid productBox={productBox} setBookedMobile={setBookedMobile}></SingleProductDetails>)
            }
            {
