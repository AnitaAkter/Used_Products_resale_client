                ...
                <div className="w-full  max-w-md p-4 rounded-md shadow sm:p-8 bg-blue-300 text-gray-900">
                    ...
                    <div className="my-6 space-y-4">
                        <button onClick={handleGoogleSignIn} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                            ...
                            <p className=' focus:dark:border-violet-400'>Login with Google</p>
                        </button>
                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between">
                                        ...
                                        <Link rel="noopener noreferrer" href="#" className="text-xs hover:underline dark:text-gray-400 font-semibold">Forgot password?</Link>
                                    </div>
