                            ...
                            <div class="w-2/3 p-4 md:p-4">
                                ...
                                <div class="gridjustify-center mt-3 item-center">
                                    <Link to={`/singleProduct/${phone?.category_id}`}>
                                        <button class="px-2 py-1 text-xs font-bold text-white uppercase transition-colors duration-300 transform bg-gray-800 rounded dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600 text-gray-800">See Products</button>
                                    </Link>
                                </div>
                            </div>
                        </div>
