...
const SingleBookingModal = ({ bookedMobile, setBookedMobile }) => {
    const { picture, title, Seller_name, category_name, location, resale_price, buying_price, Year_of_purchase, Year_of_uses, the_time_it_posted, Verified, condition, number_of_seller, details, bookingId } = bookedMobile;
