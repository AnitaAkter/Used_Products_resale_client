...
const LogIn = () => {
    ...
    return (
        <div className='bg-gradient-to-r from-blue-600 via-blue-800 to-blue-900'>
            <div className='flex gap-5 justify-between grid-cols-2 mt-5 bg-gradient-to-r from-blue-600 via-blue-800 to-blue-900'>
