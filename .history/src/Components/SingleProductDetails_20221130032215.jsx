                ...
                <div className="card-body items-center text-center">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2'>
                        ...
                        <div>
                            ...
                            <p><strong>Order Id:</strong><br className='hidden lg:block' /> {Verified}</p>
                        </div>

                    </div>
                    <div className="card-actions grid justify-center content-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
                        <button disabled={productBox.length === 0} htmlFor="booking-modal" className="btn btn-primary text-white" onClick={() => setBookedMobile(productBox)}>Buy Now</button>
