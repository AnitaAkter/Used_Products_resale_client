...
const SingleProductDetails = ({ productBox, setBookedMobile }) => {
    const { category_name, title, picture, location, buying_price, resale_price, Purchase_Year, Uses_of_Year , the_time_it_posted, Name_of_Seller, Verified, condition,number_of_seller ,    } = productBox;
    return (
        <div>
