...
const SingleBookingModal = ({ bookedMobile, setBookedMobile }) => {
    const { category_name, title, picture, location, buying_price, resale_price, Purchase_Year, Uses_of_Year, the_time_it_posted, Name_of_Seller, Verified, condition, number_of_seller, Order_id, details } = bookedMobile;
    ...
    const handleBooking = event => {
        ...
        fetch('https://server-assignment-12.vercel.app/orders', {
            method: "POST",
            headers: {
            ...
            <>
                ...
                <div className="modal">
                    <div className="modal-box relative">
                        <label htmlFor="bookingl" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
                        ...
                        <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-10'>
                            ...
                            <input name="number" type="text" placeholder="Booking ID" defaultValue={Order_id} disabled className="input w-full input-bordered" />
