                ...
                <div className="card-body items-center text-center">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2'>
                        <div>
                            ...
                            <p><strong>Selling Price:</strong> <br className='' />{resale_price}</p>
                            <p><strong>Buying Price:</strong> <br />{buying_price} </p>
                            <p><strong>Purchase Year:</strong><br /> {Purchase_Year}</p>
                            <p><strong>Uses Year:</strong> <br /> {Uses_of_Year}</p>
                            <p><strong>Location:</strong><br /> {location}</p>
                        </div>
                        <div>
                            <p><strong>Posting Time:</strong> <br />{the_time_it_posted}</p>
                            <p><strong>Seller:</strong> <br />{Name_of_Seller} </p>
                            <p><strong>Number Of Seller:</strong> <br /> {number_of_seller}</p>
