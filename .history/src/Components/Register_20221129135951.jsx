                ...
                <div className='w-96 p-7 rounded-lg border'>
                    ...
                    <form onSubmit={handleSubmit(handleSignUp)}>
                        <div className="form-control w-full max-w-xs">
                            <label className="label"> <span className="label-text text-white text-">Name</span></label>
                        ...
                        <div className="form-control w-full max-w-xs">
                            <label className="label"> <span className="label-text">Are You a Buyer or a Seller?</span></label>
