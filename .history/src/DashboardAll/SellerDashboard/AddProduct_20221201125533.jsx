            ...
            <div className='h-1/2 flex justify-center items-center'>
                <div className='w-2/3 lg:w-1/2 p-7 rounded-lg border  bg-gradient-to-r from-blue-600 via-blue-800 to-blue-900 font-bold'>
                    ...
                    <form onSubmit={handleSubmit(handleAddProdut)}>
                        ...
                        <div className="form-control w-full max-w-">
                            <label className="label"> <span className="label-text  text-white">Sale Price</span></label>
                        ...
                        <div className="form-control w-full max-w-">
                            <label className="label"> <span className="label-text  text-white">How many years you have used?</span></label>
                        ...
                        <div className="form-control w-full max-w-">
                            <label className="label"> <span className="label-text  text-white">Number</span></label>
