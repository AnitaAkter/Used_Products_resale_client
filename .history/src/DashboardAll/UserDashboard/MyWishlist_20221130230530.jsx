                            ...
                            <div className="dark:bg-gray-800 dark:text-gray-100">
                                <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-900">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <div>
                                            <a rel="noopener noreferrer" href="#" className="flex ">
                                                <img src={wishlist.picture} alt="avatar" className="object-cover  items-center w-16 h-16 mx-4 rounded-full border border-accent dark:bg-gray-500" />
                                            </a>
                                        </div>
