...
<div className="dark:bg-gray-800 dark:text-gray-100">
    <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-900">
        <div className="flex items-center justify-between">
            ...
            <a rel="noopener noreferrer" href="#" className="px-2 py-1 font-bold rounded dark:bg-violet-400 dark:text-gray-900">{wishlist.MobileName}</a>
        </div>
        <div className="mt-3">
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <div>
                <a rel="noopener noreferrer" href="#" className="flex items-center">
                    <img src={wishlist.picture} alt="avatar" className="object-cover w-10 h-10 mx-4 rounded-full dark:bg-gray-500" />
